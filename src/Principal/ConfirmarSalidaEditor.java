...
public class ConfirmarSalidaEditor extends javax.swing.JFrame {

    Fuentes Euclid = new Fuentes();
    Font Regular14p = Euclid.fuente(Euclid.EUCR, 0, 14);

    public ConfirmarSalidaEditor() {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> {
            ...
            new ConfirmarSalidaEditor().setVisible(true);
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    protected javax.swing.JButton Btn_No;
    protected javax.swing.JButton Btn_Si;
